    ...
    const resorts = [
        {
          ...
          rating: 5,
          price: "10,000 LKR",
          description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitatio. nim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.",
          images: [
      ...
      const renderStars = (rating) => {
        return Array(5).fill().map((_, i) => (
          <span key={i} className={`text-yellow-400 text-sm ${i < rating ? '' : 'opacity-30'}`}>★</span>
        ));
      };
          ...
          <SwiperSlide key={resort.id}>
            <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden">
              ...
              <div className="w-full md:w-1/2 p-6 flex flex-col">
                <div className="text-gray-600 text-sm mb-1">{resort.collection}</div>
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{resort.title}</h2>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-xl font-bold text-red-600">{resort.price}</div>
                </div>
      ...
      <div className="flex justify-center gap-2 mt-6">
        {resorts.map((_, index) => (
          <span 
            ...
            onClick={() => {
              const mainSwiper = document.querySelector('.resort-slider').swiper;
