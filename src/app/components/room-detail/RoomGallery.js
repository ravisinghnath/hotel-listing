      ...
      <div className="container">
        <div className="py-5 md:py-11">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <div className="flex">
              <Link href="#">
                <FaStar className="text-star-color" size={14} />
              </Link>
              <Link href="#">
                <FaStar className="text-star-color" size={14} />
              </Link>
          ...
          <div className="py-10">
            ...
            <p className="mt-4 text-lg leading-8 text-secondary-text md:mt-8">
              ...
              treatments. Explore the island’s rainforests, pilgrimage sites and
              fishing ports. Dine cliffside, embark on surf adventures, or
