        ...
        <div className="flex border border-1 border-border-secondary rounded-2xl flex-wrap lg:flex-nowrap">
          ...
          <div className="w-full">
            <div className="flex gap-4 flex-wrap justify-between w-full border-b-border-secondary border border-t-0 border-r-0 border-l-0 md:px-7 px-4">
              <h3 className="text-xl font-semibold text-primary-text md:py-7 pt-4">
                Deluxe Ocean View Room
              </h3>
              <h3 className="text-xl font-semibold md:py-7 text-primary-bg pb-4">
                From 10,000 LKR
              </h3>
            </div>
            <div className="md:px-7 px-4 py-5">
              ...
              <div className="md:mt-12 mt-6">
                <h6 className="text-lg text-primary-text font-semibold">
                  Features
                </h6>
                <div className="mt-4 flex gap-8 flex-wrap xl:flex-nowrap justify-between">
                  ...
                  <div className="xl:max-w-48 w-full">
                    <Link
                      href="/"
                      className=" block text-main-bg text-center font-medium px-4 py-3 rounded-full bg-primary-bg transition-all delay-300 border-2 border-primary-bg hover:bg-transparent hover:text-primary-bg mb-6"
                    >
                      Book Now
                    </Link>
                    <Link
                      href="/"
                      className="mt-4 block text-primary-bg text-center font-medium px-4 py-3 rounded-full bg-transparent transition-all delay-300 border-2 border-primary-bg hover:bg-primary-bg hover:text-white mb-6"
                    >
                      View Room Details
                    </Link>
                  </div>
